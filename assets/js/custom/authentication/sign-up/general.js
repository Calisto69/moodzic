            ...
            e = document.querySelector("#kt_sign_up_form"), t = document.querySelector("#kt_sign_up_submit"), a = KTPasswordMeter.getInstance(e.querySelector('[data-kt-password-meter="true"]')), ! function(e) {
                ...
                s.preventDefault(), r.revalidateField("password"), r.validate().then((function(r) {
                    "Valid" == r ? (t.setAttribute("data-kt-indicator", "on"), t.disabled = !0, setTimeout((function() {
                        ...
                        var dataForm = $("#kt_sign_up_form").serialize();
                        
                        doCreateAccount(dataForm);
                        ...
                        text: "Sorry, please fill all the required fileds, and try again.",
                        icon: "error",
                        buttonsStyling: !1,
                        confirmButtonText: "Ok, got it!",
                        customClass: {
...
function doCreateAccount(dataForm)
{   
    $.ajax({
        url: base_url + 'signup/isUsername',
        type: "POST",
        data: dataForm,
        async: true,
        dataType:"json",
        success: function( response ){
            if (response.status == true) {
                Swal.fire({
                    text: "Sorry, looks like this username is already exist.",
                    icon: "error",
                    buttonsStyling: !1,
                    confirmButtonText: "Ok, got it!",
                    customClass: {
